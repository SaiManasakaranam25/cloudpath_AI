...
q1 = st.selectbox("1. What is your current role?",
    ["Student", "Software Developer", "Backend Engineer", "DevOps Engineer", "Data Engineer", "IT Professional", "Career Switcher", "Other"])

q2 = st.selectbox("2. What is your experience level?",
    ["No experience yet", "0-1 years", "1-3 years", "3-5 years", "5+ years"])

q3 = st.multiselect("3. Which cloud/AI areas interest you most? (select all that apply)",
...
q4 = st.selectbox("4. What is your primary goal?",
...
q5 = st.selectbox("5. How much time can you dedicate per week?",
...
Generate a personalized Cloud and AI career roadmap. Structure your response as:
